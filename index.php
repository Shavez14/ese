...
<body>
  ...
  <nav id="menu" class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php">Aespa</a>
      </div>
  ...
  <div id="repertorio">
    <div class="container"> <!-- Container -->
      <div class="section-title">
        <h2>Repertorio de Productos Usados</h2>
        <hr>
        <div class="clearfix"></div>
      </div>
      ...
      <div class="row">
        <div class="portfolio-items">
          ...
          <div class="col-sm-6 col-md-3 col-lg-3 app">
            <div class="portfolio-item">
              <div class="hover-bg"> <a href="img/portfolio/11.jpg" rel="prettyPhoto">
                  <div class="hover-text">
                    <h4>El Eduar</h4>
                    <small>3.99$</small>
                    <div class="clearfix"></div>
                  </div>
                  <img src="img/portfolio/11.jpg" class="img-responsive" alt="Project Title">
                </a> </div>
            </div>
          </div>
          <div class="col-sm-6 col-md-3 col-lg-3 web">
